export const projectList = [
    {
        title: 'Bug Tracker',
        description: `A project management tool to assign and delegate software bugs. 
        The project was inspired by other project management tools like JIRA, Monday.com, and Azure Dev ops. Users are 
        able to create, projects and tickets with charts to display ticket priorities, type, and status of them.`,
        image: './images/dashboard.png',
        url: "https://peaceful-bastion-87144.herokuapp.com/",
        github: "https://github.com/midth002/bug-tracker",
        tools: ['React', 'Material UI', 'Node JS', 'GraphQL', 'MongoDB Atlas']
    },
        {
        title: 'MERN Stack Project Poke',
        description: `A full stack application that is built with latest technologies of React and GraphQl. Once users sign up or login, they will be able to add to an order and create their own bowl. Project features a testing of Stripe payment functionality.`,
        image: './images/project_poke.png',
        url: "https://github.com/midth002/project1",
        github: "https://github.com/midth002/project-poke",
        tools: ['React', 'Node', 'Express', 'MongoDB', 'Mongoose', 'GraphQL', 'Apollo', 'Stripe']
        }, 
        {
        ...
        {
            title: 'MVC Tech Blog',
            description: `This project is similar to a wordpress site, where developers in the tech industry can publish their blog posts. 
