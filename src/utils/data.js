export const projectList = [
    {
        ...
        tools: ['React', 'MaterialUI', 'Node', 'GraphQL']
    },
        {
        ...
        tools: ['React', 'Node', 'GraphQL', 'Apollo', 'Stripe']
        }, 
        {
